<template>
  ...
  <div>
    ...
    <div class="collapse navbar-collapse main-navbar" id="navbarResponsive">
      <a href="/" class="brand-logo ov">
        <img
          loading="lazy"
          src="../assets/logo-digipark.png"
          height="46"
          alt="Logo MyDigitalSchool"
        />
      </a>
      <form class="form-inline ml-auto">
        <a class="btn btn-light rounded-0" title="Parler à un conseiller" href="etre-appele.html">
          <span class="icon icon-call"></span>
          <span>Parler à un conseiller</span>
        </a>
        <a class="btn btn-dark rounded-0" href="inscription-aux-jpo-et-sessions-dadmissions.html"
          >JPO</a
        >
        <a class="btn btn-dark rounded-0" href="dossier-de-candidature.html">Candidature</a>
        <a class="btn btn-dark rounded-0" href="demande-de-documentation.html"> Documentation</a>
      </form>
    </div>
    ...
    <nav class="navbar navbar-expand-lg fixed-top bg-custom" id="mainNav">
      <div class="container-fluid ctnr">
        <div class="support-btns">
          <a class="navbar-brand" href="#" id="tg-menu">
            <span class="icon icon-menu icon-40px"></span>
          </a>
          <a
            class="navbar-brand d-md-none d-xl-none d-lg-none"
            title="Parler à un conseiller"
            href="etre-appele.html"
          >
...
.custom-header #mainNav .navbar-collapse {
